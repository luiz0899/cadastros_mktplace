...
public class ViewConsultaCategoria extends JFrame {
	...
	public ViewConsultaCategoria() {	
		...
		spTable.setBounds(10, 123, 628, 148);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(linhaSelecionada >=0 ) {
						...
						int opcao = JOptionPane.showConfirmDialog(contentPane, "Deseja Realmente excluir","Exclusão",JOptionPane.YES_NO_OPTION );
						if(opcao == 0 ) {
							CategoriaTableModel model =(CategoriaTableModel)tableCategorias.getModel();
							Categoria categoriaSelecionada = model.getPor(linhaSelecionada);
							try {
								...
								linhaSelecionada = -1 ;
								JOptionPane.showMessageDialog(contentPane, "Categoria editada com sucesso. ");
							} catch (Exception ex) {
								JOptionPane.showMessageDialog(contentPane, ex.getMessage() );
							}
						}
						}else {
							JOptionPane.showMessageDialog(contentPane, "Selecione para excluir");
						}
				} catch (Exception e2) {
					JOptionPane.showMessageDialog(contentPane, e2.getMessage() );
				}
	...
	private void configurarTabela ( ) {
		...
		this.configurarColuna(COLUNA_ID, COLUNA_NOME);
	}
